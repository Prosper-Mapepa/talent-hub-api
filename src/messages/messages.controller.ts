    ...
    examples: {
      jobInquiry: {
        ...
        value: {
          ...
          content:
            "Hello! I'm interested in the Junior Developer position you posted. Could you tell me more about the role and requirements?",
        },
      },
      applicationUpdate: {
        ...
        value: {
          ...
          content:
            "Thank you for your application! We've reviewed your profile and would like to schedule an interview. Are you available next week?",
        },
      },
      generalInquiry: {
        ...
        value: {
          ...
          receiverId: 'business-uuid',
          content:
            "I saw your company profile and I'm very interested in learning more about your internship opportunities for next summer.",
        },
      },
      followUp: {
        ...
        value: {
          ...
          receiverId: 'student-uuid',
          content:
            'Hi! Just following up on our previous conversation about the internship position. Do you have any questions about the role?',
        },
      },
    },
  })
      ...
      example: [
        {
          id: 'message-uuid-1',
          content:
            "Hello! I'm interested in the Junior Developer position you posted.",
          sender: {
            id: 'student-uuid-1',
            firstName: 'John',
            lastName: 'Doe',
        ...
        },
        {
          id: 'message-uuid-2',
          content:
            "Thank you for your application! We've reviewed your profile and would like to schedule an interview.",
          sender: {
            id: 'business-uuid-1',
            businessName: 'TechCorp Solutions',
            role: 'business',
        ...
        },
        {
          id: 'message-uuid-3',
          content:
            "I saw your company profile and I'm very interested in learning more about your internship opportunities.",
          sender: {
            id: 'student-uuid-2',
            firstName: 'Jane',
            lastName: 'Smith',
    ...
    schema: {
      example: [
        ...
        },
        {
          id: 'message-uuid-2',
          content:
            "Thank you for your interest! The Junior Developer role involves working with React, Node.js, and MongoDB. We're looking for someone with strong problem-solving skills and a passion for learning.",
          sender: {
            id: 'business-uuid',
            businessName: 'TechCorp Solutions',
            role: 'business',
        ...
        },
        {
          id: 'message-uuid-3',
          content:
            "That sounds perfect! I have experience with React and Node.js from my coursework and personal projects. I'd love to learn more about the team and company culture.",
          sender: {
            id: 'student-uuid',
            firstName: 'John',
            lastName: 'Doe',
        ...
        },
        {
          id: 'message-uuid-4',
          content:
            'Great! We have a collaborative team of 15 developers and we emphasize continuous learning. Would you be available for a technical interview next week?',
          sender: {
            id: 'business-uuid',
            businessName: 'TechCorp Solutions',
            role: 'business',
